...
<body onload="init();">
	<div>
		<div id="top" style="float: right; margin-top: 5px; margin-right: 132px;">
					<a href="/login/signup" class="button">회원가입</a>
					<a href="/login/check" class="button">ID/PW찾기</a>
		</div>
	</div>	
		<div>
...
<body onload="init();">
    <form action="/login/login" method="post">
		...
		<div id="top" style="float: right; margin-top: auto; margin-right: auto;">
					<a href="/login/signup" class="button">회원가입</a>
					<a href="/login/check" class="button">ID찾기</a>
					<a href="/login/check2" class="button">PW찾기</a>							
		</div>		
    </form>
    <script>
    (function(){
