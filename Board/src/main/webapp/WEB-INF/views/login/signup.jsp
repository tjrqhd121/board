...
<body>
    <form action="/login/signup" method="post" id="frm">
        ...
        <input type="text" id="id" name="id" placeholder="id" oninput="checkId()" autocomplete="off">
        <input type="password" id="pw" name="pw" placeholder="Password" autocomplete="off">
        <input type="password" id="checkpw" placeholder="Confirm Password" autocomplete="off" />
        <input name="name" id="name" placeholder="Name" autocomplete="off" />
        <input name="email" id="email" placeholder="E-mail" oninput="checkEmail()" autocomplete="off" />
        &nbsp;
        <button type="button" onclick="DosignUp();" id="signupbtn" class="btn btn-lg btn-primary btn-block">회원가입</button>	
    </form>
        ...
        $.ajax({
            ...
            success : function(data) {
                    ...
                    if(idCheck==1) {
                        ...
                        $("#signupbtn").css("background-color", "#007bff");
                        signupCheck();
                    } 
